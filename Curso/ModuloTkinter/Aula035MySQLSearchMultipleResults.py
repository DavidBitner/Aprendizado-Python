...
def procurar_cliente():
    ...
    def procurar_cliente_agora():
        ...
        resultado = my_cursor.execute(comando_sql)
        resultado = my_cursor.fetchall()
    ...
    procurar_btn.grid(row=1, column=0, columnspan=2, padx=10, pady=10)
...
procurar_cliente_btn = Button(root, text="PROCURAR", command=procurar_cliente, height=2, width=20)
