...
def procurar_cliente():
    ...
    def procurar_cliente_agora():
        ...
        comando_sql = f"SELECT * FROM clientes WHERE sobrenome = '{cliente_procurado}'"
        ...
        cliente_procurado_label.grid(row=2, column=0, columnspan=2, padx=10, pady=10)
    ...
    procurar_label = Label(procurar_cliente_window, text="Sobrenome do cliente")
